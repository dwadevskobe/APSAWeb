...
<div class ="center">
      <div class = "intro1" style = "margin-top:20px;">
        <div class = "color1 shadow" style = "margin:15px; padding:10px">
          <iframe src="//embedsocial.com/facebook_album/album_photos/1281212118583573" width="900" height="1000" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
